...
model_file = "./StockModels/gpt-neo-1.3B-24-layers/config.json"
gpt_config = AutoConfig.from_pretrained(model_file)
target = GPTNeoForCausalLM(gpt_config)

source_model = "./Models/gpt-neo-1.3B-12-layers/checkpoint-100"
...
target.save_pretrained("./Models/gpt-neo-1.3B-24-layers-init")