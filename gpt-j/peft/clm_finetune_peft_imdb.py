...
training_args = TrainingArguments(output_dir="./peft/output")
...
if "polyglot" in model_args.model_name_or_path:
...
model = AutoModelForCausalLM.from_pretrained(
    config.base_model_name_or_path, return_dict=True, load_in_8bit=False, device_map="auto"
)
