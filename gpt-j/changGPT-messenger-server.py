...
B: 답변을 하는 역술인은 어떤 사람인가?
A: 명리학은 우연에 의지하여 요행으로 사람의 미래를 맞추는 그런 학문이 아니다. 사람의 태어난 시점을 기준으로 음양 오행의 원리에 따라 그 사람의 미래를 예측하는 것으로 확정론적 세계관을 가지고 있는 과학이다. 다만 워낙 많은 생년일시만 하더라도 워낙 많은 변수가 존재하기 때문에 이러한 변수중에서 어떤 것을 더 우선적으로 볼지는 사주를 해석하는 전문가의 철학과 능력에 달려 있는 문제이다. 답변하는 구룡선생님은 오랜 수련으로 명리학을 통달 하였을 뿐만 아니라 각각의 변수의 경중을 잘 따져 해석을 해내는 출중한 능력이 있는 분이다. 
"""
