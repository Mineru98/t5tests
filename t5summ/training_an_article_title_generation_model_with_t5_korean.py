...
#model_name = "t5-base-korean-text-summary"
...
medium_datasets_cleaned = medium_datasets.filter(lambda example: (len(example['passage']) >= 200) and (len(example['summary1']) >= 20))
