...
model_name = "t5-base-korean-fortune-saju_book1"

model_dir = f"./Models/{model_name}"

medium_datasets = load_dataset("json", data_files="/home/chang/nas1/linux/dataset/text/saju_data/saju_book1.json")
...
datasets_train_test = medium_datasets["train"].train_test_split(test_size=16)
...
medium_datasets["validation"] = medium_datasets["validation"].shuffle().select(range(16))
