...
#tokenizer_path = "../train_tokenizer/tokenizer_SNS_Korean2"
tokenizer_path = "../train_tokenizer/tokenizer_wikipedia"
num_train_epochs = 2

model_name = f"dialoGPT-{model_size}-korean-chit-chat-scratch-wikipedia"
