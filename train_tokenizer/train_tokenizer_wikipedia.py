...
old_tokenizer = AutoTokenizer.from_pretrained("./tokenizer_ko_dialoGPT")
...
tokenizer.save_pretrained("./tokenizer_wikipedia")
tokenizer = AutoTokenizer.from_pretrained("./tokenizer_wikipedia")
